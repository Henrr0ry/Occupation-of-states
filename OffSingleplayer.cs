...
{
    public partial class OffSingleplayer : Form
    {
        public OffSingleplayer()
        {
            InitializeComponent();
        }
        int ZoomPicture = 1;
        ...
        public void ChangeTurn()
        {
            ...
            if (TurnFirst == true)
            {
                ...
                BotTimer.Interval = Rand.Next(1, 6) * 1000;
                BotTimer.Start();
            }
            else
            {
        ...
        private void BotTimer_Tick(object sender, EventArgs e)
        {
            try
            {
                int howmuch, whatkind, botturn = 0;
                BotTimer.Stop();
                howmuch = Rand.Next(1, 11);
                bool turncomplete = false;
                if (MainSettings.Default.BotDifficult == 1)
                    botturn = Rand.Next(1, 6);
                if (MainSettings.Default.BotDifficult == 2)
                {
                    botturn = Rand.Next(1, 7);
                    player2XP += 10;
                    Money2 += 100;
                    AtMarrine1 += 10;
                }
                if (MainSettings.Default.BotDifficult == 3)
                {
                    botturn = Rand.Next(1, 8);
                    player2XP += 20;
                    Money2 += 200;
                    AtMarrine1 += 20;
                }
                if (MainSettings.Default.BotDifficult == 4)
                {
                    Money2 = 10000000;
                    Food2 = 10000000;
                    Mine2 = 10000000;
                    ...
                    Hacker2 = 1;
                    Nuke2 = 1;
                    botturn = Rand.Next(3, 7);
                }
                //START AI
                //HUNGRY PEOPLE
                if (ErrLabel5.Visible == true)
                {
                    if (PlayerPopulation2 >= howmuch && Iron2 >= howmuch * 30 && Money2 >= howmuch * 100)
                    {
                        Farm1 += howmuch;
                        turncomplete = true;
                    }
                ...
                if (botturn == 1 && turncomplete == false)
                {
                    //SHOP BUY
                    whatkind = Rand.Next(1, 12);
                    if (whatkind == 1 && PlayerPopulation2 >= howmuch && Iron2 >= howmuch * 5 && Money2 >= howmuch * 100)
                    {
                        AtMarrine2 += howmuch;
                        PlayerPopulation2 -= howmuch;
                        Iron2 -= howmuch * 5;
                        Money2 -= howmuch * 100;
                    }
                    if (whatkind == 2 && PlayerPopulation2 >= howmuch * 5 && Iron2 >= howmuch * 100 && Money2 >= howmuch * 300)
                    {
                        AtTank2 += howmuch;
                        PlayerPopulation2 -= howmuch * 5;
                        Iron2 -= howmuch * 100;
                        Money2 -= howmuch * 300;
                    }
                    if (whatkind == 3 && PlayerPopulation2 >= howmuch * 2 && Iron2 >= howmuch * 80 && Money2 >= howmuch * 400)
                    {
                        AtPlane2 += howmuch;
                        PlayerPopulation2 -= howmuch * 2;
                        Iron2 -= howmuch * 80;
                        Money2 -= howmuch * 400;
                    }
                    if (whatkind == 4 && PlayerPopulation2 >= howmuch && Iron2 >= howmuch * 5 && Money2 >= howmuch * 100)
                    {
                        DeMarrine2 += howmuch;
                        PlayerPopulation2 -= howmuch;
                        Iron2 -= howmuch * 5;
                    ...
                    if (whatkind == 5 && PlayerPopulation2 >= howmuch && Iron2 >= howmuch * 30 && Money2 >= howmuch * 200)
                    {
                        DeTank2 += howmuch;
                        PlayerPopulation2 -= howmuch;
                        Iron2 -= howmuch * 30;
                    ...
                    if (whatkind == 6 && PlayerPopulation2 >= howmuch * 5 && Iron2 >= howmuch * 80 && Money2 >= howmuch * 300)
                    {
                        DePlane1 += howmuch;
                        PlayerPopulation2 -= howmuch * 5;
                        Iron2 -= howmuch * 80;
                    ...
                    if (whatkind == 7 && PlayerPopulation2 >= howmuch && Iron2 >= howmuch * 30 && Money2 >= howmuch * 100)
                    {
                        Farm1 += howmuch;
                        PlayerPopulation2 -= howmuch;
                        Iron2 -= howmuch * 30;
                    ...
                    if (whatkind == 8 && PlayerPopulation2 >= howmuch && Iron2 >= howmuch * 100 && Money2 >= howmuch * 200)
                    {
                        Mine2 += howmuch;
                        PlayerPopulation2 -= howmuch;
                        Iron2 -= howmuch * 100;
                    ...
                    if (whatkind == 9 && PlayerPopulation2 >= howmuch && Iron2 >= howmuch * 100 && Money2 >= howmuch * 1000)
                    {
                        Scientist2 += howmuch;
                        PlayerPopulation2 -= howmuch;
                        Iron2 -= howmuch * 100;
                    ...
                    if (whatkind == 10 && PlayerPopulation2 >= 100 && Iron2 >= 120 && Money2 >= 140000)
                    {
                        Nuke2 += howmuch;
                        PlayerPopulation2 -= 100;
                        Iron2 -= 120;
                        Money2 -= 140000;
                    }
                    if (whatkind == 11 && PlayerPopulation2 >= 1 && Iron2 >= 20 && Money2 >= 50000)
                    {
                        Hacker2 += howmuch;
                        PlayerPopulation2 -= 1;
                        Iron2 -= 20;
                ...
                //UPGRADE RESEARCH
                if (botturn == 2 && turncomplete == false)
                {
                    howmuch = Rand.Next(1, 12);
                    if (howmuch == 1 && AtMarrine2lvl < 3 && player2XP > 1000)
                    {
                        player2XP -= 1000;
                        AtMarrine2lvl++;
                    }
                    else
                     if (howmuch == 2 && AtTank2lvl < 3 && player2XP > 6000)
                    {
                        player2XP -= 6000;
                        AtTank2lvl++;
                    }
                    else
                     if (howmuch == 3 && AtPlane2lvl < 3 && player2XP > 5000)
                    {
                        player2XP -= 5000;
                        AtPlane2lvl++;
                    }
                    else
                     if (howmuch == 4 && DeMarrine2lvl < 3 && player2XP > 1000)
                    {
                        player2XP -= 1000;
                        DeMarrine2lvl++;
                    }
                    else
                     if (howmuch == 5 && DeTank2lvl < 3 && player2XP > 5000)
                    {
                        player2XP -= 5000;
                        DeTank2lvl++;
                    }
                    else
                     if (howmuch == 6 && DePlane2lvl < 3 && player2XP > 4500)
                    {
                        player2XP -= 4500;
                        DePlane2lvl++;
                    }
                    else
                     if (howmuch == 7 && FLab2lvl < 3 && player2XP > 4000)
                    {
                        player2XP -= 8000;
                        FLab2lvl++;
                    }
                    else
                     if (howmuch == 8 && FFarm2lvl < 3 && player2XP > 2500)
                    {
                        player2XP -= 2500;
                        FFarm2lvl++;
                    }
                    else
                     if (howmuch == 9 && FMine2lvl < 3 && player2XP > 2500)
                    {
                        player2XP -= 2500;
                        FMine2lvl++;
                    }
                    else
                     if (howmuch == 10 && SNuke2lvl < 1 && player2XP >= 8000)
                    {
                        player2XP -= 8000;
                        SNuke2lvl++;
                    }
                    else
                     if (howmuch == 11 && SHacker2lvl < 1 && player2XP >= 5000)
                    {
                        player2XP -= 5000;
                        SHacker2lvl++;
                    }
                ...
                //HACKER
                if (botturn == 3 && turncomplete == false)
                {
                    if (Hacker2 > 0)
                    {
                        Hacker2--;
                    ...
                    if (Hacker2 == 0 && SHacker2lvl == 1 && PlayerPopulation2 >= 1 && Iron2 >= 20 && Money2 >= 50000)
                    {
                        Hacker2 += howmuch;
                        PlayerPopulation2 -= 1;
                        Iron2 -= 20;
                    ...
                    if (SHacker2lvl < 1 && player2XP >= 5000)
                    {
                        player2XP -= 5000;
                        SHacker2lvl++;
                    }
                ...
                //NUKE
                if (botturn >= 5 && turncomplete == false)
                {
                    if (Hacker2 > 0)
                    {
                        do
                        {
                            howmuch = Rand.Next(0, LongInt + 1);
                        } while (OccuState2[howmuch] == true);
                        Bitmap bm = (Bitmap)MainMap.BackgroundImage;
                        new FillColorClass().FloodFill(ref bm, Color.DimGray, StatePoint[howmuch]);
                        MainMap.BackgroundImage = bm;
                        if (OccuState1[howmuch] == true)
                        {
                            PlayerPopulation1 -= Population[howmuch];
                            Mine1 -= IronMine[howmuch];
                            Farm1 -= FoodsProduction[howmuch];
                            OccuState1[howmuch] = false;
                        }
                        if (OccuState2[howmuch] == true)
                            MessageBox.Show("boom lol");
                        if (NameState[howmuch] == StartS1)
                        {
                            VLabel.Text = Name2;
                            DLabel.Text = Name1;
                            EndPanel.Visible = true;
                        ...
                        {
                            StateDestroy[howmuch] = true;
                            ChangeTurn();
                            UpdateView();
                        }
                    }
                    else
                    if (Nuke2 < 1 && SNuke2lvl == 1 && PlayerPopulation2 >= 100 && Iron2 >= 120 && Money2 >= 140000)
                    {
                        Nuke2 += howmuch;
                        PlayerPopulation2 -= 100;
                        Iron2 -= 120;
                ...
                {
                    howmuch = Rand.Next(0, LongInt + 1);
                    int marrinehit = Rand.Next(0, AtMarrine2 + 1);
                    int tankhit = Rand.Next(0, AtTank2 + 1);
                    int planehit = Rand.Next(0, AtPlane2 + 1);
                    int damage = 0;
                    damage += tankhit * 10 + tankhit * 100 + planehit * 90;
                    AtMarrine2 -= marrinehit;
                    AtTank2 -= tankhit;
                    AtPlane2 -= planehit;
                    int protection = 0;
                    protection += DeMarrine1 * 10 + DeTank1 * 100 + DePlane1 * 90;
                    if (OccuState1[howmuch] == false && StateDestroy[howmuch] == false)
                    {
                        OccuState2[howmuch] = true;
                        PlayerPopulation2 += Population[howmuch];
                        Mine2 += IronMine[howmuch];
                        Farm2 += FoodsProduction[howmuch];
                        Bitmap bm = (Bitmap)MainMap.BackgroundImage;
                        new FillColorClass().FloodFill(ref bm, Color.Red, StatePoint[howmuch]);
                        MainMap.BackgroundImage = bm;
                    }
                    else
                    if (damage > protection && OccuState1[howmuch] == true && StateDestroy[howmuch] == false)
                    {
                        OccuState1[howmuch] = false;
                        OccuState2[howmuch] = true;
                        DeMarrine1 -= marrinehit;
                        DeTank1 -= tankhit;
                        DePlane1 -= planehit;
                        PlayerPopulation2 += Population[howmuch];
                        Mine2 += IronMine[howmuch];
        ...
        public void EuropeMap_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                LogoBox1.Refresh();
                if (MainSettings.Default.BotDifficult == 1)
                    LogoBox2.Image = Properties.Resources.IconBot1;
                if (MainSettings.Default.BotDifficult == 2)
                    LogoBox2.Image = Properties.Resources.IconBot2;
                if (MainSettings.Default.BotDifficult == 3)
                    LogoBox2.Image = Properties.Resources.IconBot3;
                if (MainSettings.Default.BotDifficult == 4)
                    LogoBox2.Image = Properties.Resources.IconBot4;
                LogoBox2.Refresh();
            }
            catch
            {
        ...
        private void Attack_Click(object sender, EventArgs e)
        {
            ...
            this.tabControl2.SelectedTab = this.Page1;
            if (TurnFirst == true)
            {
